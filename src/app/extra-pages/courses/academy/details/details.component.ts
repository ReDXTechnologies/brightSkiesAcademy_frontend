...
import { demoCourseSteps , categories, courses} from './data';
...
@Component({
  ...
  standalone     : true,
  imports: [MatSidenavModule, RouterLink, MatIconModule, NgIf,
    NgClass, NgFor, MatButtonModule, MatProgressBarModule, CdkScrollable,
    MatTabsModule, FuseFindByKeyPipe, FuseFindByKeyPipe, FuseFindByKeyPipe],
})
export class AcademyDetailsComponent implements OnInit, OnDestroy
{
  ...
  ngOnInit(): void {
    ...
    this.course.steps = demoCourseSteps;
    console.log("hiiiii");
