...
export class DepartmentService extends UnsubscribeOnDestroyAdapter{
  ...
  getSuperDepartmentByCourseId(course_id : any): Observable<Department> {
    const url = `${this.baseUrl}/superdepartment/${course_id}/depByCourse`;
    return this.http.get<Department>(url);
  }
  ...
  getSubDepartmentsByCourseId(course_id : any): Observable<Department> {
    const url = `${this.baseUrl}/subdepartment/${course_id}/depByCourse`;
    return this.http.get<Department>(url);
  }
